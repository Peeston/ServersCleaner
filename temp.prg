...
*!*		GO top
*!*		Go i
*!*		Store czn.Марка To scale_code1
...
*!*		Insert Into czn(КодТовара,Товар, КолВо, Цена, Сумма, Точка, Касса, РРО, ДатаВремя_, Фискальный, Марка ,Дата_Возвр, firstStamp, inPack, СуммаПоУпа);
*!*		 Select КодТовара,Товар, КолВо, Цена, Сумма, Точка, Касса, РРО, ДатаВремя_, Фискальный, Марка, Дата_Возвр, IIF(f=1 AND EMPTY(Дата_Возвр),1,0), inPack,;
*!*		  IIF(f=1,(SELECT SUM(VAL(Сумма)) FROM  czn WHERE NVL(firstStamp,0)=0 AND Марка=m.scale_code1 AND ! EMPTY(КодТовара) AND NVL(inPack,0)>0),0) From czn Where Recno()=i
*!*		
*!*		Select czn
*!*		GO top
*!*		Go i
*!*		Store czn.Марка To scale_code2
*!*		
*!*	Endfor
