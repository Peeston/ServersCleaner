*!*	SELECT DISTINCT кодтовара as kod, товар as tovar, 0000 as orig FROM czn WHERE ! EMPTY(кодтовара) ORDER BY кодтовара, товар desc   INTO CURSOR t1 READWRITE 
*!*	SELECT SUM(1) as kol, кодтовара as kod  FROM czn GROUP BY кодтовара  INTO CURSOR koll
